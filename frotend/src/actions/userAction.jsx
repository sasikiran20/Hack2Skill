...
export function login(email, password) {
  return async function (dispatch) {
    ...
    const cleanedStr = emailValue.replace(/^"|"$/g, '');
    ...
    try {
      ...
      const dataMan = response.data;
      console.log(dataMan);
      addProductsToCart(dataMan.cartItems, dispatch);
    } catch (error) {
...
const addProductsToCart = async (cartItems, dispatch) => {
  try {
    ...
    for (const item of cartItems) {
      ...
      dispatch({
        ...
        payload: {
          ...
          quantity, // The quantity from cartItems
        },
      });
    }
  } catch (error) {
